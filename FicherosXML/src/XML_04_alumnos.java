...
public class XML_04_alumnos implements Serializable {
	...
	public XML_04_alumnos(String nombre, byte edad, byte noGrupo, float alturaAproxEnMetros, boolean juegaEnConsola,
	...
	public static XML_04_alumnos[] getListaAlumnos() {
